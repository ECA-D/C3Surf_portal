...
<a href="https://www.euro4m.eu" target="_blank">EURO4M</a>
...
FP7 <a href="https://www.uerra.eu" target="_blank">UERRA</a>
		...
		<br><br>
		  ...
		  <table border="0" style="padding: 8px; background: #f4f4f4; border-bottom: 1px solid #999; box-shadow: 0px 5px 5px #666; margin-bottom: 20px;" width="100%">
			...
			<td width="75%"><span style="color:#FFFFFF;"><strong>Index</strong></span></td>
		      ...
		      <tr>
			<td>APGD</td>
			<td><a href="../images/mean_annual_precip_APGD.jpg">Mean annual precipitation [mm/year]</a><br><a href="../images/Frequency_wet_days_APGD.jpg">Frequency of wet days (&geq;1 mm) [fraction]</a><br><a href="../images/mean_annual_maximum_1-day_precipitation_APGD.jpg">Mean of annual maximum daily precipitation [mm/d]</a></td>
		      </tr>
		      <tr bgcolor="#ffffff">
			<td>APGDEns</td>
