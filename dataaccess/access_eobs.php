...
<html style="" class="js js canvas no-touch rgba opacity cssanimations csstransforms csstransforms3d csstransitions svg inlinesvg WebfontLoader-processed bootstrap-anchors-processed wf-opensans-n4-active wf-opensans-n7-active wf-active" dir="ltr" prefix="content: http://purl.org/rss/1.0/modules/content/ dc: http://purl.org/dc/terms/ foaf: http://xmlns.com/foaf/0.1/ og: http://ogp.me/ns# rdfs: http://www.w3.org/2000/01/rdf-schema# sioc: http://rdfs.org/sioc/ns# sioct: http://rdfs.org/sioc/types# skos: http://www.w3.org/2004/02/skos/core# xsd: http://www.w3.org/2001/XMLSchema#" lang="en">
		...
		<div id="block-system-main" class="block block-system col-xs-12 col-sm-12 col-md-12 col-lg-12 clearfix">
		  ...
		  <table border="0" style="padding: 8px; background: #f4f4f4; border-bottom: 1px solid #999; box-shadow: 0px 5px 5px #666; margin-bottom: 20px;" width="100%">
			...
			<td width="50%"><span style="color:#FFFFFF;"><strong>Modification</strong></span></td>    
		      ...
		      <tr>
			<td><a href="access_eobs.php#datafiles">16.0</a></td>
			<td>September 2017</td>
			<td>1950-01-01 - 2017-08-31</td>
			<td>Series for Estonia have been updated. Monthly, half-yearly and yearly updates are continued for Germany, Czech Republic, Bosnia and Herzegovina, Norway, Slovenia, Finland, Ireland, Sweden, Luxembourg, Netherlands, Portugal, Spain, Switzerland, Catalonia, France and Denmark. More detailed information can be found on the <a href="http://cib.knmi.nl/mediawiki/index.php/Compare_E-OBS_v16.0_and_v15.0" target="_blank">page comparing versions 16.0 and 15.0</a>. 
			</td>   
		      </tr>
		    </tbody>
		  </table>
 Information on older versions of E-OBS can be found <a href="http://www.ecad.eu/download/ensembles/oldversions.php">here</a>. 
		...
		<h3> E-OBS datafiles 1950-01-01 - 2017-08-31</h3>
		...
		<table  border="0" style="padding: 8px; background: #f4f4f4; border-bottom: 1px solid #999; box-shadow: 0px 5px 5px #666; margin-bottom: 20px;" width="100%">
		  <tbody>
		    <tr bgcolor="#941333" height="40px">
		      <td width="25%" style="color:#FFFFFF;"><b>Version 16.0</b></td>
		    ...
		    <tr>
		      ...
		      <td><a href="http://www.ecad.eu/download/ensembles/data/Grid_0.25deg_reg/tg_0.25deg_reg_v16.0.nc.gz">TG</a> <a href="http://www.ecad.eu/download/ensembles/data/Grid_0.25deg_reg/tn_0.25deg_reg_v16.0.nc.gz">TN</a> <a href="http://www.ecad.eu/download/ensembles/data/Grid_0.25deg_reg/tx_0.25deg_reg_v16.0.nc.gz">TX</a> <a href="http://www.ecad.eu/download/ensembles/data/Grid_0.25deg_reg/rr_0.25deg_reg_v16.0.nc.gz">RR</a> <a href="http://www.ecad.eu/download/ensembles/data/Grid_0.25deg_reg/pp_0.25deg_reg_v16.0.nc.gz">PP</a></td>
		      <td><a href="http://www.ecad.eu/download/ensembles/data/Grid_0.25deg_reg/tg_stderr_0.25deg_reg_v16.0.nc.gz">TG</a> <a href="http://www.ecad.eu/download/ensembles/data/Grid_0.25deg_reg/tn_stderr_0.25deg_reg_v16.0.nc.gz">TN</a> <a href="http://www.ecad.eu/download/ensembles/data/Grid_0.25deg_reg/tx_stderr_0.25deg_reg_v16.0.nc.gz">TX</a> <a href="http://www.ecad.eu/download/ensembles/data/Grid_0.25deg_reg/rr_stderr_0.25deg_reg_v16.0.nc.gz">RR</a> <a href="http://www.ecad.eu/download/ensembles/data/Grid_0.25deg_reg/pp_stderr_0.25deg_reg_v16.0.nc.gz">PP</a></td>
		      <td><a href="http://www.ecad.eu/download/ensembles/data/Grid_0.25deg_reg/elev_0.25deg_reg_v16.0.nc.gz">all elements</a></td> 
		    </tr>
		    <tr>
		      <td>0.50 deg. regular grid</td>
		      <td><a href="http://www.ecad.eu/download/ensembles/data/Grid_0.50deg_reg/tg_0.50deg_reg_v16.0.nc.gz">TG</a> <a href="http://www.ecad.eu/download/ensembles/data/Grid_0.50deg_reg/tn_0.50deg_reg_v16.0.nc.gz">TN</a> <a href="http://www.ecad.eu/download/ensembles/data/Grid_0.50deg_reg/tx_0.50deg_reg_v16.0.nc.gz">TX</a> <a href="http://www.ecad.eu/download/ensembles/data/Grid_0.50deg_reg/rr_0.50deg_reg_v16.0.nc.gz">RR</a> <a href="http://www.ecad.eu/download/ensembles/data/Grid_0.50deg_reg/pp_0.50deg_reg_v16.0.nc.gz">PP</a></td>
		      <td><a href="http://www.ecad.eu/download/ensembles/data/Grid_0.50deg_reg/tg_stderr_0.50deg_reg_v16.0.nc.gz">TG</a> <a href="http://www.ecad.eu/download/ensembles/data/Grid_0.50deg_reg/tn_stderr_0.50deg_reg_v16.0.nc.gz">TN</a> <a href="http://www.ecad.eu/download/ensembles/data/Grid_0.50deg_reg/tx_stderr_0.50deg_reg_v16.0.nc.gz">TX</a> <a href="http://www.ecad.eu/download/ensembles/data/Grid_0.50deg_reg/rr_stderr_0.50deg_reg_v16.0.nc.gz">RR</a> <a href="http://www.ecad.eu/download/ensembles/data/Grid_0.50deg_reg/pp_stderr_0.50deg_reg_v16.0.nc.gz">PP</a></td>
		      <td><a href="http://www.ecad.eu/download/ensembles/data/Grid_0.50deg_reg/elev_0.50deg_reg_v16.0.nc.gz">all elements</a></td> 
		    </tr>
		    <tr>
		      <td>0.22 deg. rotated grid</td>
		      <td><a href="http://www.ecad.eu/download/ensembles/data/Grid_0.22deg_rot/tg_0.22deg_rot_v16.0.nc.gz">TG</a> <a href="http://www.ecad.eu/download/ensembles/data/Grid_0.22deg_rot/tn_0.22deg_rot_v16.0.nc.gz">TN</a> <a href="http://www.ecad.eu/download/ensembles/data/Grid_0.22deg_rot/tx_0.22deg_rot_v16.0.nc.gz">TX</a> <a href="http://www.ecad.eu/download/ensembles/data/Grid_0.22deg_rot/rr_0.22deg_rot_v16.0.nc.gz">RR</a> <a href="http://www.ecad.eu/download/ensembles/data/Grid_0.22deg_rot/pp_0.22deg_rot_v16.0.nc.gz">PP</a></td>
		      <td><a href="http://www.ecad.eu/download/ensembles/data/Grid_0.22deg_rot/tg_stderr_0.22deg_rot_v16.0.nc.gz">TG</a> <a href="http://www.ecad.eu/download/ensembles/data/Grid_0.22deg_rot/tn_stderr_0.22deg_rot_v16.0.nc.gz">TN</a> <a href="http://www.ecad.eu/download/ensembles/data/Grid_0.22deg_rot/tx_stderr_0.22deg_rot_v16.0.nc.gz">TX</a> <a href="http://www.ecad.eu/download/ensembles/data/Grid_0.22deg_rot/rr_stderr_0.22deg_rot_v16.0.nc.gz">RR</a> <a href="http://www.ecad.eu/download/ensembles/data/Grid_0.22deg_rot/pp_stderr_0.22deg_rot_v16.0.nc.gz">PP</a></td>
		      <td><a href="http://www.ecad.eu/download/ensembles/data/Grid_0.22deg_rot/elev_0.22deg_rot_v16.0.nc.gz">all elements</a></td> 
		    </tr>
		    <tr>
		      <td>0.44 deg. rotated grid</td>
		      <td><a href="http://www.ecad.eu/download/ensembles/data/Grid_0.44deg_rot/tg_0.44deg_rot_v16.0.nc.gz">TG</a> <a href="http://www.ecad.eu/download/ensembles/data/Grid_0.44deg_rot/tn_0.44deg_rot_v16.0.nc.gz">TN</a> <a href="http://www.ecad.eu/download/ensembles/data/Grid_0.44deg_rot/tx_0.44deg_rot_v16.0.nc.gz">TX</a> <a href="http://www.ecad.eu/download/ensembles/data/Grid_0.44deg_rot/rr_0.44deg_rot_v16.0.nc.gz">RR</a> <a href="http://www.ecad.eu/download/ensembles/data/Grid_0.44deg_rot/pp_0.44deg_rot_v16.0.nc.gz">PP</a></td>
		      <td><a href="http://www.ecad.eu/download/ensembles/data/Grid_0.44deg_rot/tg_stderr_0.44deg_rot_v16.0.nc.gz">TG</a> <a href="http://www.ecad.eu/download/ensembles/data/Grid_0.44deg_rot/tn_stderr_0.44deg_rot_v16.0.nc.gz">TN</a> <a href="http://www.ecad.eu/download/ensembles/data/Grid_0.44deg_rot/tx_stderr_0.44deg_rot_v16.0.nc.gz">TX</a> <a href="http://www.ecad.eu/download/ensembles/data/Grid_0.44deg_rot/rr_stderr_0.44deg_rot_v16.0.nc.gz">RR</a> <a href="http://www.ecad.eu/download/ensembles/data/Grid_0.44deg_rot/pp_stderr_0.44deg_rot_v16.0.nc.gz">PP</a></td>
		      <td><a href="http://www.ecad.eu/download/ensembles/data/Grid_0.44deg_rot/elev_0.44deg_rot_v16.0.nc.gz">all elements</a></td> 
		    </tr>
		  <tbody>
		</table>
