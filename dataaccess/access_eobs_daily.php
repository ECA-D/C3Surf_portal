...
<html style="" class="js js canvas no-touch rgba opacity cssanimations csstransforms csstransforms3d csstransitions svg inlinesvg WebfontLoader-processed bootstrap-anchors-processed wf-opensans-n4-active wf-opensans-n7-active wf-active" dir="ltr" prefix="content: https://purl.org/rss/1.0/modules/content/ dc: https://purl.org/dc/terms/ foaf: https://xmlns.com/foaf/0.1/ og: https://ogp.me/ns# rdfs: https://www.w3.org/2000/01/rdf-schema# sioc: https://rdfs.org/sioc/ns# sioct: https://rdfs.org/sioc/types# skos: https://www.w3.org/2004/02/skos/core# xsd: https://www.w3.org/2001/XMLSchema#" lang="en">
  ...
  <head>
    ...
    <title>Access to daily E-OBS updates</title>
   ...
   <?php include('../include/header.php'); ?>  
	...
	<div id="globalpageheader">
		...
		<div id="block-delta-blocks-page-title" class="block block-delta-blocks col-xs-12 col-sm-12 col-md-12 col-lg-12 clearfix">
		  <h1 id="page-title" class="title">Access to daily E-OBS updates</h1>
		</div> <!-- /.block -->
	      </div>
	    </div>
          </div>
    ...
    <div id="mainwrapper" class="wrapper clearfix ">
      <div id="maincontainer" class="container">
		...
		<!-- Breadcrum -->
		<h2 class="element-invisible">You are here</h2><div class="breadcrumb"><span class="inline odd first"><a href="../surfobs.php">Home</a></span><span class="delimiter">&raquo;</span> <span class="inline even last"><a href="access_eobs.php">E-OBS data</a></span>&raquo;</span> <span class="inline even last"><a href="access_eobs_daily.php">Access to daily E-OBS updates</a></span></div>

		<!-- Main part -->
		<div id="block-system-main" class="block block-system col-xs-12 col-sm-12 col-md-12 col-lg-12 clearfix">


                  This is the download page for the preliminary daily updates of the gridded observational dataset for precipitation and temperature in Europe called E-OBS. For questions regarding E-OBS, please contact us at <a href="mailto:&#101;&#099;&#097;&#064;&#107;&#110;&#109;&#105;&#046;&#110;&#108;?subject=Questions E-OBS">&#101;&#099;&#097;&#064;&#107;&#110;&#109;&#105;&#046;&#110;&#108;</a>.<br><br>
 The intended use of the daily updates of E-OBS is to provide a view how a climatic extreme unfolds. As the calculations are based on the set of meteorological data that is available in real-time, which is considerably less than what is used for the monthly or half-yearly updates, users are advised not to make their climatological analyses on the basis of these daily updated datasets.


		  <h3>Data files</h3>
		  
		  The daily updated E-OBS dataset for temperature and precipitation is available through the KNMI Data Platform. The table below gives the link to the download pages. The last 60 days are available through the KNMI Data Platform as to have at least the days available from the <a href="access_eobs_months.php">last monthly update</a> until yesterday. The data will usually become available during the next morning.
		  ...
		  <table border="0" style="padding: 8px; background: #f4f4f4; border-bottom: 1px solid #999; box-shadow: 0px 5px 5px #666; margin-bottom: 20px;" width="100%">
			...
			<td width="100%"><span style="color:#FFFFFF;"><strong>Access to dataset</strong></span></td>
		      </tr>
		      <tr>
			<td><a href="https://dataplatform.knmi.nl/dataset/daily-updated-tn-eobs-1">Gridded daily updated daily minimum temperature data (TN)</a></td>
		      </tr>
		      <tr bgcolor="#ffffff">
			<td><a href="https://dataplatform.knmi.nl/dataset/daily-updated-tg-eobs-1">Gridded daily updated daily mean temperature data (TG)</a<</td>
		      </tr>
		      <tr>
			<td><a href="https://dataplatform.knmi.nl/dataset/daily-updated-tx-eobs-1">Gridded daily updated daily maximum temperature data (TX)</a></td>
		      </tr>
		      <tr bgcolor="#ffffff">
			<td><a href="https://dataplatform.knmi.nl/dataset/daily-updated-rr-eobs-1">Gridded daily updated daily precipitation data (RR)</a></td>
		      </tr>
		    </tbody>
		  </table>
		...
		<h3>Citation and acknowledgement</h3>
                      ...
                      Ensemble version:<br>
                      "We acknowledge the E-OBS dataset from the Copernicus Climate Change Service, and the data providers in the ECA&D project (https://www.ecad.eu)"<br>
