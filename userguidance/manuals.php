   ...
   <?php include('../include/header.php'); ?>  
	...
	<div id="globalpageheader">
		...
		<div id="block-delta-blocks-page-title" class="block block-delta-blocks col-xs-12 col-sm-12 col-md-12 col-lg-12 clearfix">
		  <h1 id="page-title" class="title">User manuals</h1>
		</div> <!-- /.block -->
	      </div>
	    </div>
          </div>
    ...
    <div id="mainwrapper" class="wrapper clearfix ">
      <div id="maincontainer" class="container">
		...
		<!-- Breadcrum -->
		<h2 class="element-invisible">You are here</h2><div class="breadcrumb"><span class="inline odd first"><a href="../surfobs.php">Home</a></span><span class="delimiter">&raquo;</span> <span class="inline even last"><a href="manuals.php">User manuals</a></span></div>

		<!-- Main part -->
		<div id="block-system-main" class="block block-system col-xs-12 col-sm-12 col-md-12 col-lg-12 clearfix">
		  User manuals and documentation for the scripts to calculate several indices development within this service can be accessed below.<br><br>
		...
		<table  border="0" style="padding: 8px; background: #f4f4f4; border-bottom: 1px solid #999; box-shadow: 0px 5px 5px #666; margin-bottom: 20px;" width="100%">
		  <tbody>
                   <tr bgcolor="#941333" height="40px">
                      <td width="100%" style="color:#FFFFFF;"><b>Manual</b></td>
                    </tr>
 		    <tr>
		      <td><a href="../documents/C3S_D311a_Lot4.3.1.5_user_manual_PET_v5_APPROVED_Ver2.pdf">Potential EvapoTranspiration (PET) based on the Makkink approach</a>
		      </td>
		    </tr>
		    <tr>
		      <td><a href="../documents/C3S_D311a_Lot4.3.1.9_user_manual_PET-PM_v2.pdf">Potential EvapoTranspiration (PET) based on the Penman-Monteith approach</a>
		      </td>
		    </tr>
		    <tr>
		      <td><a href="../documents/C3S_D311a_Lot4.3.1.7_UserManual_scPDSI_v3.pdf">self-calibration Palmer Drought Severity Index (scPDSI)</a>
		      </td>
		    </tr>
		    <tr>
		      <td><a href="../documents/C3S_D311a_Lot4.3.1.10_script_and_manual_UTCI_v1.pdf">Universal Thermal Climate Index (UTCI)</a>
		      </td>
		    </tr>
		  <tbody>
		</table>
