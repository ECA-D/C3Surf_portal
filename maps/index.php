   ...
   <?php include('../include/header.php'); ?>  
	...
	<div id="globalpageheader">
		...
		<div id="block-delta-blocks-page-title" class="block block-delta-blocks col-xs-12 col-sm-12 col-md-12 col-lg-12 clearfix">
		  <h1 id="page-title" class="title">Dataset maps</h1>
		</div> <!-- /.block -->
	      </div>
	    </div>
          </div>
    ...
    <div id="mainwrapper" class="wrapper clearfix ">
      <div id="maincontainer" class="container">
		...
		<!-- Breadcrum -->
		<h2 class="element-invisible">You are here</h2><div class="breadcrumb"><span class="inline odd first"><a href="../surfobs.php">Home</a></span><span class="delimiter">&raquo;</span> <span class="inline even last"><a href="index.php">Dataset maps</a></span></div>

		<!-- Main part -->
		<div id="block-system-main" class="block block-system col-xs-12 col-sm-12 col-md-12 col-lg-12 clearfix">
		  Visualization for each dataset is provided below.
		  <br><br>
		...
		<table  border="0" style="padding: 8px; background: #f4f4f4; border-bottom: 1px solid #999; box-shadow: 0px 5px 5px #666; margin-bottom: 20px;" width="50%">
		  <tbody>
		    ...
		    <tr>
		      <td><a href="eobsdailymaps.php">E-OBS</a>
		      </td>
		    </tr>		  
		    <tr>
		      <td><a href="eobsindicesmaps.php">E-OBS Indices</a>
		      </td>
		    </tr>		  
		  <tbody>
		</table>
