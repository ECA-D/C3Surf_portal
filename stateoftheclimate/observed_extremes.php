    ...
    <div id="mainwrapper" class="wrapper clearfix ">
      <div id="maincontainer" class="container">
		...
		<div id="block-system-main" class="block block-system col-xs-12 col-sm-12 col-md-12 col-lg-12 clearfix">
		  Below is a link to the tables with observed highest <font color="#0033cc">minimum</font> and <font color="#e60000">maximum</font> temperatures.  Data in these tables are sourced from the National Meteorological and Hydrological Services through the <a href="https://rcccm.dwd.de/DWD-RCCCM/EN/products/significant/significant_node.html" target="_blank">WMO RA VI RCC Network</a>. 
<br><br><br>

<a href="https://rcccm.dwd.de/DWD-RCCCM/EN/products/significant/records/records_tmax_tmin.pdf?__blob=publicationFile&v=11">Temperature records in Europe (PDF)</a>
